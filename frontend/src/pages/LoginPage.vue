<template>
  <section class="flex-1">
    <div class="flex flex-col items-center p-4 mx-auto mt-40 w-64 bg-gray-800 rounded drop-shadow-md">
      <div class="text-xl text-white font-medium mb-4">
...
.login-button {
  @apply bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-6 rounded-lg;
}
